...
export default function PageError({ error, reset }) {
  ...
  return (
    <main className="stagger mx-auto flex min-h-[70vh] max-w-lg flex-col justify-center gap-4 px-4">
      <h1 className="display text-[27px] leading-[1.12] text-white/95">This page couldn&apos;t load</h1>
