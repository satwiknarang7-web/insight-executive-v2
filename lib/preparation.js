...
/**
 * Accept the steps a model proposed, in order, against the real columns.
 *
 * Returns the ones that plan, with an id and the model's reason, plus the
 * columns that exist once they have all run — which is what the measures below
 * are validated against, since a measure the model wrote over a column one of
