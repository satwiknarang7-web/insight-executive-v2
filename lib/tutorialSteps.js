...
export const TUTORIAL_STEPS = [
  {
    ...
    body: 'Drag and drop a CSV or Excel file here to get started. It is read in your browser, and nothing leaves it unless a model is in use — your own key, or ours on Pro.',
    placement: 'left',
  },
  {
...
export const PAGE_ADVANCE = {
  ...
  '/dashboard': 'Open Data table in the sidebar whenever you want to carry on.',
  '/explore': 'Open Ask a question in the sidebar for the last part of the tour.',
};
