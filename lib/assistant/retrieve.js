...
export const HELP = [
  ...
  { id: 'help:assistant', title: 'The assistant', page: null, text: 'The assistant answers questions about the app and your data, and can change the dashboard (add, edit, remove or move charts, set filters, add KPIs, add measures, fix how a column was read) and shape the data (transform steps). It always shows what it plans to change, and nothing happens until you click Apply. Every applied change can be undone.' },
];
