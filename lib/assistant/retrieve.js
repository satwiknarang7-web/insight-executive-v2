...
export const HELP = [
  ...
  { id: 'help:explore', title: 'Data table and data prep', page: '/explore', text: 'The Data table page profiles every column (type, spread, top values, how full it is), shows the rows with search and sorting, and has a Transform data button for shaping the data: rename, drop or keep columns, add calculated columns, filter rows, split or combine columns, change types, fill blanks, replace values, remove duplicates, band numbers, extract date parts, group and pivot. Steps are applied in order and can be removed. Changing the data rebuilds the dashboard. The assistant can also make these changes for you: say, for example, "rename region to area", "remove duplicates" or "drop the notes column".' },
  { id: 'help:quality', title: 'Cleaning report', page: '/quality', text: 'The Cleaning report shows what the cleaner did to the data: types read, values fixed, blanks, duplicates and suspect cells, in plain words.' },
  { id: 'help:model', title: 'How tables join', page: '/model', text: 'When several tables or sheets are loaded, the How tables join page shows which is the main (fact) table and how the others join to it. You can change the main table and the joins.' },
  ...
  { id: 'help:present', title: 'Slideshow', page: '/present', text: 'The Slideshow opens the dashboard of the dashboard, as slides, one chart per slide with its narration. Use the arrow keys to move between slides.' },
