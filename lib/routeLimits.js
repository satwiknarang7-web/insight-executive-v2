...
export const LIMITS = {
  ...
  // One model call that plans a whole deck. Rarer than a question and dearer
  // than one, so it gets its own allowance rather than sharing `ask`.
  dashboardPlan: { limit: 40, windowMs: FIFTEEN_MINUTES },
