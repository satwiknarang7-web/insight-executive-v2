...
const ALIASES = {
  ...
  // Natural Earth's UK units predate some reorganisations and carry a few
  // names; these map today's names onto its shapes.
  GBC: {
    'city of edinburgh': 'edinburgh',
    'glasgow city': 'glasgow', 'aberdeen city': 'aberdeen', 'dundee city': 'dundee', 'county durham': 'durham', 'rhondda cynon taff': 'rhondda cynon taf', 'western isles': 'na h eileanan siar', 'eilean siar': 'na h eileanan siar', hull: 'kingston upon hull',
    'kingston upon hull city of': 'kingston upon hull', 'bristol city of': 'bristol', 'city of bristol': 'bristol', 'isle of anglesey': 'anglesey', 'herefordshire county of': 'herefordshire',
    'bournemouth christchurch and poole': ['bournemouth', 'poole'], bcp: ['bournemouth', 'poole'], 'derry city and strabane': ['derry', 'strabane'], londonderry: 'derry',
    'north northamptonshire': 'northamptonshire', 'west northamptonshire': 'northamptonshire',
    cumberland: 'cumbria', 'westmorland and furness': 'cumbria', 'shetland': 'shetland islands', 'orkney islands': 'orkney', 'city of york': 'york',
    ...
    merseyside: ['knowsley', 'liverpool', 'sefton', 'wirral', 'st helens'],
...
function lookup() {
  ...
  for (const [code, map] of Object.entries(INDEX)) {
    ...
    // Groups the build wrote (Greater London's boroughs), by region id.
    for (const [name, ids] of Object.entries(map.groups || {})) t.set(normalize(name), ids);
