...
/**
 * The column an aggregate carries to say how many values it rests on.
 *
 * Named with underscores so it cannot collide with a column out of somebody's
 * spreadsheet, and lifted out of the results before anything draws them — see
 * `liftSupport` in lib/pipeline.js. It exists so a finding can tell the
 * difference between an average of thirty values and an average of one.
 */
export const SUPPORT_KEY = '__support_n';
