...
const LOADERS = {
  ...
  // REST-backed, so no driver package behind any of these.
  clickhouse: () => import('./clickhouse.server.js'),
  databricks: () => import('./databricks.server.js'),
  trino: () => import('./trino.server.js'),
  airtable: () => import('./airtable.server.js'),
  mongodb: () => import('./mongodb.server.js'),
};
