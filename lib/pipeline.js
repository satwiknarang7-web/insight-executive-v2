...
export function runAnalysis(
   ...
   */
  let specs = planned;
  // A model-composed deck belongs to the playbook. On the question path a model
  // shapes the deck through the questions it proposes (lib/modelQuestions.js),
  // which go through the compiler like every other question.
