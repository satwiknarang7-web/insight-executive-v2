...
export function runAnalysis(
  ...
  const planned = planCharts(rows, { max: target, provenance, roles, claims, profile: shape, repeated, purpose, brief });
  ...
  const kpis = planKpis(rows, { provenance, roles, claims, profile: shape, repeated, purpose, brief });
