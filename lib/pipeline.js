...
import { aggregateTitle } from './aggregateNames.js';
...
export function runAnalysis(
  ...
  const specs = planCharts(rows, { max: target, provenance, roles, claims, profile: shape, repeated, brief });
  const kpis = planKpis(rows, { provenance, roles, claims, profile: shape, repeated, brief });
