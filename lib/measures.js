...
import { FUNCTION_NAMES } from './engineFunctions.js';
 ...
 *
 * The list is the engine's own: every function `engineFunctions.js` registers
 * is a function a formula may name, and nothing else is. `IFNULL` is alasql's
 * alias for COALESCE and predates that module.
 */
const SCALARS = new Set([...FUNCTION_NAMES, 'IFNULL']);
