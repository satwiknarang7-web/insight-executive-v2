...
import MeasureBuilder from '../panels/MeasureBuilder';
import MeasureReference from '../panels/MeasureReference';
import DerivedMeasures from '../panels/DerivedMeasures';
  ...
  return (
    <div>
      <p className="mb-4 text-[12px] leading-relaxed text-white/40">
        A measure is a calculation this file does not contain — a margin, a rate, an average per
        something. Unlike a step above, it does not change the table: it is a named aggregate the
        charts and cards can use, and it recomputes when the data does.
      </p>
